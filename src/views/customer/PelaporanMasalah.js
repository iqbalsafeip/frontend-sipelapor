...
import { buatLaporan, createUser, getLaporan } from "src/redux/actions";
import { Link } from "react-router-dom";

const fields = ["no", "status", "tanggal_buat", "show_details"];
      ...
      <CCard>
        <CCardHeader>
          ...
          <div className="card-header-actions">
            <CButton className="btn btn-primary" onClick={handleLaporan}>
              Buat Laporan
            </CButton>
          </div>
        </CCardHeader>
